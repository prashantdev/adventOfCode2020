...
def computeDistance():
    ...
    global nMoved
    global sMoved
    manDist=abs(eMoved-wMoved)+abs(nMoved-sMoved)
    return manDist
...
def printMovement():
    ...
    global nMoved
    global sMoved
    print("e+w="+str(abs(eMoved-wMoved))+" n+s="+str(abs(nMoved-sMoved)))
